          ...
          <div className="max-w-3xl">
            <div
              className="prose prose-neutral max-w-none
                ...
                prose-h2:mt-12 prose-h2:text-xl prose-h2:first:mt-0
            ...
            >
              ...
              <ul>
                <li>
                  <strong>Director and officer information</strong>: name,
                  date of birth, address, email, phone number, and consent
                ...
                <li>
                  <strong>Member information</strong>: names and contact
                  details of company members.
                </li>
                <li>
                  <strong>Financial information</strong>: bank account
                  details necessary to make payments to grant recipients.
                </li>
                <li>
              ...
              <p>
                ...
                where practicable, including via registration forms, grant
                application forms, our website contact form, and
                correspondence.
              </p>
              ...
              <ul>
                <li>
                  register and administer the company under the Corporations
                  Act 2001 (Cth);
                </li>
              ...
              <ul>
                <li>
                  as required by law, for example disclosure to ASIC of
                  director details under the Corporations Act 2001 (Cth);
                </li>
                <li>
              ...
              <p>
                Director names and addresses are disclosed to ASIC and appear
                on the public register as required by law. If and when Tiny
                Sports Limited is registered as a charity with the Australian
                Charities and Not-for-profits Commission (ACNC), the names of
                Responsible Persons (directors) will also be published on the
                ACNC Charity Register, a public register accessible online.
                This is a mandatory disclosure requirement under the ACNC Act
                2012 (Cth).
              </p>
              ...
              <p>
                ...
                where held, are kept in a secure location. Our website uses
                only the technical cookies necessary for the site to function
                and does not use cookies to build advertising profiles of
                visitors.
              </p>

              <h2>7. Access and Correction</h2>
              <p>
                Individuals may request access to personal information we
                hold about them, or request correction of inaccurate
              ...
              <h2>8. Complaints</h2>
              <p>
                Complaints about our handling of personal information should
                be directed to{' '}
                <a href="mailto:jake.martin@tiny-sports.org">
                  jake.martin@tiny-sports.org
                </a>
                . If a complaint is not resolved to your satisfaction, you
